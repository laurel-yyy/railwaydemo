...
(
    ...
    `carriage_number` varchar(64) COLLATE latin1_general_ci DEFAULT NULL,
...
(
    ...
    `train_id`        bigint(20) DEFAULT NULL,
    `carriage_number` varchar(64) COLLATE latin1_general_ci DEFAULT NULL,
    `seat_number`     varchar(64) COLLATE latin1_general_ci DEFAULT NULL,
    `seat_type`       int(3) DEFAULT NULL,
    `start_station`   varchar(256) COLLATE latin1_general_ci DEFAULT NULL,
    `end_station`     varchar(256) COLLATE latin1_general_ci DEFAULT NULL,
    ...
    PRIMARY KEY (`id`),
    KEY               `idx_train_id` (`train_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1683022080920494081 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;

CREATE TABLE `t_station`
(
    `id`          bigint(20) unsigned NOT NULL AUTO_INCREMENT,
    `code`        varchar(64) COLLATE latin1_general_ci DEFAULT NULL,
...
(
    `id`             bigint(20) unsigned NOT NULL AUTO_INCREMENT,
    `train_number`   varchar(256) COLLATE latin1_general_ci DEFAULT NULL,
    `start_station`  varchar(256) COLLATE latin1_general_ci DEFAULT NULL,
    `end_station`    varchar(256) COLLATE latin1_general_ci DEFAULT NULL,
...
(
    ...
    `sequence`       varchar(32) COLLATE latin1_general_ci DEFAULT NULL,
    `departure`      varchar(64) COLLATE latin1_general_ci DEFAULT NULL,
    `arrival`        varchar(64) COLLATE latin1_general_ci DEFAULT NULL,
    `arrival_time`   datetime DEFAULT NULL,
    `departure_time` datetime DEFAULT NULL,
...
(
    ...
    PRIMARY KEY (`id`),
    KEY           `idx_train_id` (`train_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1677692017354547201 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
(
    ...
    PRIMARY KEY (`id`),
    KEY              `idx_train_id` (`train_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1677689610742865921 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;

CREATE TABLE `t_user_0` (
    `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
    `username` varchar(256) COLLATE latin1_general_ci DEFAULT NULL,
    `password` varchar(512) COLLATE latin1_general_ci DEFAULT NULL,
    `real_name` varchar(256) COLLATE latin1_general_ci DEFAULT NULL,
    PRIMARY KEY (`id`),
...
CREATE TABLE `t_order_0` (
    `id`             bigint(20) unsigned NOT NULL AUTO_INCREMENT,
    `order_sn`       varchar(64) COLLATE latin1_general_ci DEFAULT NULL,
